<?php
	...
	{
?>
<iframe height=300 width=600 name='embed_readonly' src='http://beta.etherpad.org/p/<? echo $newstory1; ?>?showControls=false&showChat=false&showLineNumbers=true&useMonospaceFont=false'></iframe>
...
<iframe height=300 width=600 src="http://beta.etherpad.org/p/HanselGretelAssignStudent22"></iframe>
...
<table width=1200>
	<tr>
		...
		<td align=center><a href='student2.php?pg=2'>Next</a></td>
	</tr>
</table>
<? } else { ?>

<iframe height=300 width=600 name='embed_readonly' src='http://beta.etherpad.org/p/<? echo $newstory3; ?>?showControls=false&showChat=false&showLineNumbers=true&useMonospaceFont=false'></iframe>
...
<iframe height=300 width=600 src="http://beta.etherpad.org/p/HanselGretelAssignStudent24"></iframe>
...
<table width=1200>
	<tr>
		<td align=center><a href='student2.php?pg=1'>Previous</a></td>
